...
#Region " Windows Form Designer generated code "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Me.cmbReasonTypes.Location = New System.Drawing.Point(138, 21)
        ...
        Me.txtdesc.Location = New System.Drawing.Point(138, 92)
        ...
        Me.txtrej.Location = New System.Drawing.Point(138, 58)
        ...
        Me.btnsave.Location = New System.Drawing.Point(150, 162)
        ...
        Me.ClientSize = New System.Drawing.Size(419, 199)
    ...
    Private Sub btnsave_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnsave.Click
        ...
        Else
            ...
            If Me.Tag = "I" Then
                ...
                sql = "select rejcd from Reasons where rejcd = '" & Trim(txtrej.Text) & "' and rtype = '" & sReasonType & "'"
                ds = db.selectQuery(sql)
                If ds.Tables(0).Rows.Count = 0 Then
                    sql = "insert into Reasons(rtype,rejcd,dsca) values ('" & sReasonType & "','" & Trim(txtrej.Text) & "','" & Trim(txtdesc.Text) & "')"
                    ...
                    End If
                Else
                    MsgBox("Reason code already exists", MsgBoxStyle.Critical)
                End If
